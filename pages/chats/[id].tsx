...
const ChatDetail: NextPage = () => {
    return (
        <div className="py-10 px-4 pb-16 space-y-4">
            ...
            <div className="fixed w-full mx-auto max-w-md bottom-2 left-0 inset-x-0">
                <div className="flex relative items-center">
                    <input
                        type="text"
                        className="shadow-sm rounded-full w-full border-gray-300 focus:ring-orange-500 focus:outline-none pr-2 focus:border-orange-500"
                    />
